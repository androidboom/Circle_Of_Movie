package com.example.liubo.world_of_movie.BaseView;
...
/**
 * Created by Liubo on 2017/12/26.
 */

public class MyAlarmView extends View {
    private Paint paint;
    private int maxWidth = 95;
    ...
    private void init() {
        paint = new Paint();
        paint.setColor(getResources().getColor(R.color.ssf_main_color));// 此处颜色可以改为自己喜欢的
